    ...
    <div className="relative w-full min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <div className="relative flex flex-col text-left h-full p-5 lg:p-16">
          ...
          <h2 className="text-white text-xl w-full md:w-[75%] xl:w-[50%] mt-4">This application is about showing what I'm about, and what I do. My projects can be found further down</h2>
      ...
      <h2 className='text-white text-2xl font-semibold mb-6'>My projects</h2>

...
const ProjectDetail: React.FC = () => {
  ...
  return (
    <div className="project-detail text-left relative overflow-hidden">
      ...
      {/* Check if project is of type FrontendProject */}
      {project.type === 'frontend' && (
        <div className="flex flex-col lg:flex-row justify-center mx-auto px-3 md:px-12 mt-16 w-[80%] relative">
          ...
          <div className="relative w-full lg:w-[50%] mx-auto justify-center">
            <img
              className="rounded-md h-[280px] lg:max-h-[280px] lg:max-w-[394px] mx-auto lg:ml-0 lg:mr-auto relative z-10 object-cover"
          ...
          <div className="relative w-full lg:w-[50%] mx-auto lg:ml-10 xl:mx-auto mt-24 mb-6 lg:my-0">
            <h2 className="ubuntu-bold text-2xl text-center lg:text-left font-semibold text-white px-3 mb-3">
              Details about {project.title}
            </h2>
            <p className="projects-list text-white text-left px-3 overflow-y-auto md:h-[222px] lg:h-auto max-h-[168px] md:max-h-[222px]">
              {project.description}
            </p>
          </div>
        </div>
      ...
      {project.type === 'frontend' && (
        <div className="flex flex-col-reverse lg:flex-row mt-[50px] lg:mt-[100px] justify-center mx-auto px-3 md:px-12 w-[80%] relative">
          <div className="lg:w-[50%]">
            ...
            <p className="projects-list text-white text-left px-3 overflow-y-auto max-h-[96px] lg:max-h-[140px]">
              {project.details}
            </p>
          </div>
